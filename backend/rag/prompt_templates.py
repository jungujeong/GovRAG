...
{context_block}
        ...
        [형식 지침 - 마크다운 사용]
        - 마크다운 형식을 사용하여 가독성 높은 답변을 작성하세요
        - 주제별로 명확한 제목(### 제목)을 사용하세요
        - 항목이 여러 개일 때는 번호 목록(1., 2., 3.) 또는 불릿(-)을 사용하세요
        - 단락 사이에 빈 줄을 넣어 읽기 편하게 구성하세요
        ...
        [답변 예시]
        ### 홍티예술촌 개요
        홍티예술촌은 지역 예술가들의 창작 공간으로 조성된 문화예술 공간입니다. [1]

        ### 주요 활동
        1. 입주 작가들의 작품 전시 및 창작 활동 [1]
        2. 지역 주민을 위한 문화 프로그램 운영 [2]
