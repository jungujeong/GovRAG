...
class PromptTemplates:
    ...
    SYSTEM_PROMPT = dedent(
        ...
        - **고유명사는 문서 원문을 복사-붙여넣기하듯이 정확히 옮겨 쓰세요**
        - 절대 단어를 변형하거나 유사한 단어로 치환하지 마세요
        - 예시: "홍티예술촌" → "홍티아트바이브" (❌ 절대 금지)
        - 예시: "나무 식재" → "나무 식 Planting" (❌ 절대 금지)
        - **영어 단어를 한국어 문장에 임의로 삽입하지 마세요**
        ...
        - 고유명사, 숫자, 날짜는 문서에 쓰인 표기를 한 글자도 바꾸지 말고 그대로 사용하세요
        - 문서에 없는 부연설명을 추가하지 마세요
        - 한국어 표현을 영어로 번역하거나 변환하지 마세요
